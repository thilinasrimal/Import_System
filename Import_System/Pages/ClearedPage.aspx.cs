...
{
    public partial class ClearedPage : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "SELECT * FROM Import_Shedules im where im.IsCleared=1 and im.IsDelete is NULL ORDER by im.con_no ASC";
